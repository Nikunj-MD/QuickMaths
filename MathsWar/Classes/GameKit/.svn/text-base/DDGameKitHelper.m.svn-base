        ...
        [localPlayer authenticateWithCompletionHandler:^(NSError* error)
         {
             if (error != nil)
             {
                 UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"Game Center" message:[error localizedDescription] delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
                 [alert show];
                 [alert release];
             }
             else
    ...
    [newScore reportScoreWithCompletionHandler:^(NSError* error) 
     {
         ...
         {
             UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"Game Center" message:@"Score successfully shared." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
             [alert show];
             [alert release];
         }
...
-(void) showLeaderboardwithCategory:(NSString*)category timeScope:(int)tscope 
{
    ...
    NSLog(@"showLeaderboardwithCategory");
    GKLeaderboardViewController* leaderboardVC = [[GKLeaderboardViewController alloc] init] ;
    if (leaderboardVC != nil)
    {
        leaderboardVC.leaderboardDelegate = self;
